...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-3 col-3 col-lg-3 col-sm-5 col-xs-12 text-center " style="margin-bottom: 5px;">
                                ...
                                @auth
                                    ...
                                    <a  class="btn btn-lg btn-primary text-center" style="border: 2px #eee double;
                                            font-weight: bolder; background: #37c6f5" data-toggle="modal" data-target="#payWithTipMe">TipMe</a>
                                    @endif
                                @endauth
                                <a  class="btn-lg btn-primary text-center" style="border: 2px #eee double;
                                            font-weight: bolder; background: #37c6f5" href="{{route('add.to.cart', $publication->id) }}">Add to <i class="fa fa-shopping-cart"></i></a>
                            </div>
                            <div class="col-md-9 col-9 col-lg-9 col-sm-7 col-xs-12 mt-2">
                                <div class="mu-author-infos">
                                    ...
                                    <h5 style="color: #71818f; line-height: 2px; font-family: 'Poppins-Regular">
                                        Publisher: <i class="fa fa-user" ></i> {{(empty($publication->publisher)) ? : $publication->publisher->name}}</h5>
                                    <hr />
    ...
    @include('site.pages.tipme.js')
    @include('site.pages.tipme.modal')
