            ...
            <div class="x_content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="tipMePay" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            <div class="modal-body">
                                @csrf
                                <div class="form-group row ">
                                    <label class="control-label col-md-3 col-sm-3 ">CID/BID:<span class="required">*</span></label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control" placeholder="CID0000001" name="cid" id="getCid" required>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <form id="tipMeVerify" method="POST" autocomplete="false" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="submit" name="submit" class="btnverifypin btn btn-primary">Verify PIN</button>
                            </div>
                        </form>
            ...
            <div class="x_content">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <h5 id="cmobile"></h5>
                        <form id="tipMeOtpVerify" method="POST" autocomplete="off" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            <div class="modal-body">
                                @csrf
                                <div class="form-group row ">
                                    <label class="control-label col-md-3 col-sm-3 ">OTP Code:<span class="required">*</span></label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="password" class="form-control" name="otp" id="OtpCode"  autocomplete="off"  required>
                                        <input type="hidden" class="form-control" value="{{Cart::session(Auth::id())->getTotal()}}" id="ItemPrice" readonly name="price"  autocomplete="off"  required>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="submit" name="submit" class="btnverifyotp btn btn-primary">Verify OTP</button>
                            </div>
                        </form>
